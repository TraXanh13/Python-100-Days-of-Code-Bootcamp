...
PATH = "C:/Users/minia/Documents/Projects/Python-100-Days-of-Code-Bootcamp/Day 26/us-states/"
statesGuessed = []
missingStates = []
answer = ""
...
while len(statesGuessed) < 50:
    answer = screen.textinput(
        title=f"{len(statesGuessed)}/50 Guess the State", prompt="Guess a state's name?").title()

    if answer == "Exit":
        missingStates = [
            state for state in allStates if state not in statesGuessed]
